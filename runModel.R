...
#                          dendritesPerNeuronMax = 15,
#                          synapsesPerDendriteMin = 15,
...
points(sumAmyloidAggregatesSize / sumAmyloidAggregatesCount / amyloidAggregateGeneration_aggregateMaxSize, col = "purple2")
points((sumAmyoidPlaques / countAmyoidPlaques) / amyloidPlaqueGeneration_plaqueMaximumSize, col = "purple4")
points(alivePerc, col = "red4")
